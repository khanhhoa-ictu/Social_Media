                ...
                <div className="p-3">
                    <div className="d-flex justify-content-between">
                        ...
                        <UncontrolledDropdown inNavbar nav className='list-unstyled'>
                            <DropdownToggle nav>
                                <ButtonStyled>
                                    <svg aria-label="Tùy chọn khác" className="_8-yf5 cursor-pointer" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
                        ...
                        <span>
                            <span onClick={changeLikePost}>
                                {liked ?
                                    ...
                                    :
                                    <svg aria-label="Thích" className="_8-yf5 cursor-pointer" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
                            ...
                            <NavLink to={`/post/${post._id}`} >
                                <svg aria-label="Bình luận" className="_8-yf5 cursor-pointer mx-3" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
                            ...
                            <svg aria-label="Chia sẻ bài viết" className="_8-yf5 cursor-pointer" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
                                <line fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth="2" x1="22" x2="9.218" y1="3" y2="10.083"></line>
                                <polygon fill="none" points="11.698 20.334 22 3.001 2 3.001 9.218 10.084 11.698 20.334" stroke="currentColor" strokeLinejoin="round" strokeWidth="2"></polygon>
                            </svg>
                        </span>
                        <svg aria-label="Lưu" className="_8-yf5 cursor-pointer" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
