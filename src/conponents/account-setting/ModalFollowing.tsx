...
import { getFollower, getFollowing } from '../../api/user.api'
        ...
        >
            <div className="">
                <ModalBody className="p-0 d-flex flex-column">
                    <ModalTitle className="text-center h6 py-2 title">Người theo dõi</ModalTitle>
                    {
                        follower.length > 0 && follower?.map((item: FollowingsType, key: number) => {
                            return <div className="px-3 d-flex align-items-center" key={key}>
                                <NavLinkHover
