        ...
        <div className="h-100">
            <div className="d-flex h-100 justify-content-end flex-column pb-4">
                ...
                <BoxInput className="mt-auto d-flex align-items-center mx-4 border">
                    ...
                    <CommentInput type="text" className="shadow-none font-14" placeholder="Thêm bình luận ..." />
                    <ButtonPostStyled className='text-primary px-1 font-14'>Gửi</ButtonPostStyled>
                </BoxInput>
            </div>
        </div>
    )
