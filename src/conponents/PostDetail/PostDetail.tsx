...
const PostDetail = (props: PostDetailProps) => {
    ...
    return (
        <ModalStyled
            ...
            centered
            className='modal border-none m-auto'
        >
                    ...
                    <div className="post">
                        <div className="border-bottom p-3">
                            <div className="d-flex justify-content-between align-items-center">
                                ...
                                <p className="btn border-none p-0 mb-0 text-primary font-14">Theo dõi</p>
                            </div>
                        </div>
                        <div className='ms-3'>
            ...
            <div className="d-sm-none d-block">
                <div className="d-flex justify-content-between p-2 align-items-center">
                    ...
                    <p className="btn border-none px-1 mb-0 text-primary font-14">Theo dõi</p>
                </div>
